...
echo "# Test of a Zero-Coupon Bond Merkleized"
...
marlowe-cli template zcb --minimum-ada "$MINIMUM_ADA"               \
                         ...
                         --merkleized                               \
                         --out-contract-file tx-1.merkleized        \
                         --out-state-file    tx-1.state

jq '.[0][1]' tx-1.merkleized > tx-1.contract
...
marlowe-cli run prepare --marlowe-file tx-1.marlowe           \
                        ...
                        --merkleized-contract-continuation-file tx-2.contract \
                        --invalid-before "$NOW"               \
...
marlowe-cli run prepare --marlowe-file tx-2.marlowe                \
                        ...
                        --merkleized-contract-continuation-file tx-3.contract \
                        --invalid-before "$NOW"                    \
                        --invalid-hereafter "$((NOW+4*HOUR))"      \
